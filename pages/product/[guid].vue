<template>
  <Head>
    <Title>NFT Marketplace - {{ selectedItem.name }}</Title>
    <Meta name="title" :content="'NFT Marketplace -' + selectedItem.name" />
    <Meta name="description" content="NFT Marketplace страница товара" />
    <Meta property="og:title" content="NFT Marketplace" />
    <Meta property="og:description" content="NFT Marketplace страница товара" />
    <Meta name="twitter:title" content="NFT Marketplace" />
    <Meta name="twitter:description" content="NFT Marketplace страница товара" />
  </Head>
...
const selectedItem = computed(() => items.value.find(i => i.guid === route.params.guid))
</script>